...
public class VRTeleporter_L : MonoBehaviour
{
    ...
    public void Teleport()
    {
        if (groundDetected)
        {
            ...
            Vector3 tmp = bodyTransforn.position;
            tmp.y = 1.31f;
            bodyTransforn.position = new Vector3(bodyTransforn.position.x,tmp.y,bodyTransforn.position.z);
